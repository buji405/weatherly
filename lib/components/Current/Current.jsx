...
export default function Current(props) {
  ...
  const switchButton = props.dailyAppear ? 'switch-selection-left' :
  ...
  return (
    <div >
      ...
      <div className='temp-container'>
        ...
        <h3 className='current-temp'>{props.weatherData.current}
